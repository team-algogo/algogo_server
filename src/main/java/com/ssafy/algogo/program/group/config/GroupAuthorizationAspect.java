...
public class GroupAuthorizationAspect {
    ...
    public void checkGroupRole(JoinPoint joinPoint, GroupAuthorize groupAuthorize)
        throws Throwable {
        // 현재 로그인한 사용자 ID 추출
        ...
        GroupsUser groupsUser = groupUserRepository.findByProgramIdAndUserIdAndProgramUserStatus(
                groupId, userId, ProgramUserStatus.ACTIVE)
