...
public interface ProgramProblemService {
    ...
    void createProgramProblem(Long programId, ProgramProblemCreateRequestDto programProblemCreateRequestDto);
    void deleteProgramProblem(Long programId, List<Long> programProblems);
}
