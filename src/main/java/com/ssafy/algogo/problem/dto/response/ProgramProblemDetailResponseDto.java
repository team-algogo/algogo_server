...
public record ProgramProblemDetailResponseDto(
    ...
    public static ProgramProblemDetailResponseDto from(ProgramProblem programProblem) {
        return new ProgramProblemDetailResponseDto(
